...
This is a worked example. The product is fictional. The architecture is what `architecture-ready` produces when run end-to-end against the worked PRD at `prd-ready/references/EXAMPLE-PRD.md`. It feeds the worked roadmap (`roadmap-ready/references/EXAMPLE-ROADMAP.md`) and the worked stack decision (`stack-ready/references/EXAMPLE-STACK.md`).
